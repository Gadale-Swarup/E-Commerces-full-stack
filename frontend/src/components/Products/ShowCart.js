...
const ShowCart = ({cart=[]}) => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen px-14 py-7">
      {/* My Cart */}
        ...
        <div className="flex flex-col p-4 text-lg font-semibold shadow-md border rounded-sm">
          ...
          <div className="flex flex-row self-center gap-1">
            ...
            <input
              ...
              readOnly
              value={quantity}
              className="w-8 h-8 text-center text-white text-sm outline-none border border-gray-300 rounded-sm"
            />
      ...
      <div className="flex flex-col w-full md:w-2/3 h-fit gap-4 p-4">
        ...
        <div className="flex flex-col p-4 gap-4 text-lg font-semibold shadow-md border rounded-sm">
          ...
          <div className="flex flex-row justify-between">
            ...
            <a className="text-gray-500 text-base underline" href="l">
              Add
            </a>
          </div>
          <hr className="bg-gray-200 h-0.5" />
